...
public class IndiciReplyKeyboardMarkup implements CustomReplyKeyboard{

	/**
	 * Array of button rows, each represented by an Array of Strings
	 * */
	@JsonProperty("keyboard")
    private String[][] keyboard= new String[][] {{"Indici Ieri", "Indici Oggi"}, {"Start"}};
 ...
 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IndiciReplyKeyboardMarkup other = (IndiciReplyKeyboardMarkup) obj;
